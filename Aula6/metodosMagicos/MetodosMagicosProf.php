...
// Copiado do Professor: http://www.dontpad.com/501-php/Aula6/MetodosMagicos.php

class MetodosMagicosProf
{
    ...
    function __invoke()
    {
        ...
        return "Este objeto não pode ser chamado como função";
        // $obj();
    }
    /**
     * sleep
